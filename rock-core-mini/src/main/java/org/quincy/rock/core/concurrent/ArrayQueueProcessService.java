 ...
 * @since 1.0
 */
public class ArrayQueueProcessService<K, V> extends BoundedQueueProcessService<K, V> {
	/**
	 * 处理器。
	 */
	 ...
	 * 无。
	 */
	public ArrayQueueProcessService() {
		this(2, 1024);
	}
	 ...
	 */
	public ArrayQueueProcessService(int maxThreadCount, int capacity) {
