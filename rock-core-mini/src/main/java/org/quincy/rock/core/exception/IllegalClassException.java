 ...
 * <!-- 在此添加修改列表，参考第一行内容 -->
 * <tr><td>1</td><td>wks</td><td>2018年4月18日 下午2:32:55</td><td>建立类型</td></tr>
 * 
 * </table>
 * @version 1.0
 * @author wks
 * @since 1.0
 */
public class IllegalClassException extends RockException {
	/**
	 * serialVersionUID。
	 */
	...
	public IllegalClassException(String message, Throwable cause, boolean enableSuppression,
