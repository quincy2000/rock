 ...
 * @since 1.0
 */
public class InfoRecorder extends TraceRecorder {
	/**
	 * logger。
	 */
	private static final Logger logger = RockUtil.getLogger(InfoRecorder.class);
	...
	public boolean canWrite() {
		return super.canWrite() && logger.isInfoEnabled();
	}
